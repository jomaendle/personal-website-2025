...
In contrast, many sans-serif or serif fonts, such as Arial or T2imes New Roman have proportional character widths, where each character has a different width depending on its shape. This can cause numbers to appear misaligned.
