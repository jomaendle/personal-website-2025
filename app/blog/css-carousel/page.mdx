...
Read more in the [CSS Overflow Level 5 specification](https://www.w3.org/TR/css-overflow-5/#scroll-markers).
...
<div className="absolute left-0 right-0 p-4 max-w-4xl xl:max-w-5xl min-h-[420px] mx-auto w-full z-50">
  <CarouselCode />
</div>

<div className="w-full h-[820px] md:h-[420px]"></div>
