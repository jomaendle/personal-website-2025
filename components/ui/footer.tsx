 ...
 *
 * The name appears once. The copyright line used to repeat it, so the footer
 * read "Jo Mändle ... © Jo Mändle" a few centimetres apart. The wordmark is the
 * signature; the notice only needs the year.
 */

/**
 * Evaluated once per build. Every route rendering the footer is
 * `force-static`, so this is baked into the HTML at build time and refreshes on
 * the next deploy rather than at midnight on New Year.
 */
