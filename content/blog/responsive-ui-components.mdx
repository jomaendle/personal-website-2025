...
<BlogH1>Making Responsive UI Components with display: contents</BlogH1>
...
<BlogImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*L8pxygaGeA2JzaG750XlcA.png" caption="Figure 1: Mobile and desktop layouts of the card component." />
...
<BlogImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*K7It3-ar-rVJID995bUevg.gif" caption="Figure 2: Responsive Card component which changes the CTA position, based on the screen size." />
