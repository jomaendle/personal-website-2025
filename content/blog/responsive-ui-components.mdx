...
<h1 className="text-2xl font-normal tracking-tight mb-8">Making Responsive UI Components with display: contents</h1>
...
<H2>A Real-World Example: Responsive Card Layout</H2>
...
<figure>
    <img src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*L8pxygaGeA2JzaG750XlcA.png"
         alt="Responsive Card Layout"/>
    <figcaption>Figure 1: Mobile and desktop layouts of the card component.</figcaption>
</figure>

<H2>What problem does `display: contents` solve?</H2>
...
<figure>
    <img src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*K7It3-ar-rVJID995bUevg.gif"
         alt="Responsive Card Layout"/>
    <figcaption>Figure 2: Responsive Card component which changes the CTA position, based on the screen size.</figcaption>
</figure>
