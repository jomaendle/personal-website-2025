import {BlogH1, H2, H3} from "../../components/ui/heading";
import {BlogImage} from "../../components/blog-image";
import {CodeBlock} from "../../components/code-block";

<BlogH1>Align Dates in Tabular Data</BlogH1>
...
<BlogImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*q3Bb46brRSHGAo76UdDT-A.png" caption="Figure 1: Using the Inter font by Google, we can reproduce the visual disharmony in the “Creation Date” column." />
...
<BlogImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*PJXyqfKmGSuz7r9rIdIGkA.png" caption="Figure 2: A consistent date format already improves the readability, but it is still not perfect yet." />

<H3>2. Align the Spacing of the Digits</H3>
...
<BlogImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*ISG9gJMNawgKIZe-yFipVA.png" caption="Figure 3: Applying the CSS font-variant-numeric style ensures consistent widths for each of the digits." />
