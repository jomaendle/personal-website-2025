...
<BlogH1>Animating Gradients in CSS</BlogH1>
...
<BlogImage src="https://miro.medium.com/v2/resize:fit:1332/format:webp/1*nvQURWW56-rIIBn5wmURoA.gif" caption="Figure 1: What we see on the screen with the styles from above" />
...
<H2>A better approach — using modern CSS @property</H2>
...
<H2>And this is what we get</H2>

<BlogImage src="https://miro.medium.com/v2/resize:fit:1400/format:webp/1*-DCI2Og7dN9TAhLEgccKgg.gif" caption=" Figure 2: A smooth transition between the colors of the gradient" />
