 ...
 *
 * This trims and length-caps only — it does NOT make a string safe to embed in
 * HTML. Always pass the result through `escapeHtml` from `lib/html-utils.ts`
 * before interpolating it into an email body.
 */
